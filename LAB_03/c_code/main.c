...
int main(void) {
    ...
    // Main game loop
    while (!WindowShouldClose() && !finishGame) {  
        //----------------------------------------------------------------------------------
        // Update
        //----------------------------------------------------------------------------------
        ...
        switch (currentScreen) {
            ...
            case SCREEN_TITLE: {
                framesCounter++;
                if (IsKeyPressed(KEY_ENTER)) { // Update TITLE screen
                    PlaySound(fxStart);
                    currentScreen = 2;
                }
            } 
            ...
            case SCREEN_GAMEPLAY: {// Update GAMEPLAY screen
            ...
            case SCREEN_ENDING: { // Update ENDING screen
                if (IsKeyPressed(KEY_ENTER)) {
                    //currentScreen = 1;
                    finishGame = true;
                }
            ...
            switch (currentScreen) {
                ...
                case SCREEN_LOGO: {
                     DrawTexture(texLogo, GetScreenWidth()/2 - texLogo.width/2,
                      GetScreenHeight()/2 - texLogo.height/2 - 40, Fade(WHITE, alphaLogo));
                } 
                break;

                case SCREEN_TITLE: {
                    DrawTextEx(fntTitle, "SUPER PONG", (Vector2){ 200, 100 }, 
                    fntTitle.baseSize*6, 4, LIME);
                ...
                case SCREEN_GAMEPLAY: {
                    ...
                    DrawText(TextFormat("%04i", enemyScore), 
                                screenWidth - 200, 10, 30, DARKGREEN);
